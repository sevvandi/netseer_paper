...
def generate_graph_exp(
    ...
    Randomly generates an exponentially growing list of graphs using supplied parameters.
...
def generate_next_graph(
    ...
    # add edges
    non = functions.get_neighbours_of_neighbours(gr)
    edges_to_add = non[
