---
title: "Netseer: R Package for Graph Prediction using Adapted Flux Balance Analysis"
output:
  # pdf_document: default
  html_document:
    df_print: paged
vignette: "%\\VignetteIndexEntry{The R package netseer} %\\VignetteEngine{knitr::rmarkdown}
...
The underlying algorithm is described in [@Kandan_2026].
An illustation is given in this vignette. 
...
Similarly, we can predict the graph at 3 time steps ahead.
There is no explciit limit on $h$, but as we get further into the future, the predictions are less accurate.
