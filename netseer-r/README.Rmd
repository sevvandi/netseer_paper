...
Before starting, download the [data.zip](./data.zip) directory under `/netseer-paper/netseer-r/`. This directory contains 20 example graphs. Extract the zip to your project root.  
